...
//    RooFormulaVar *n2_p0_dn = new RooFormulaVar("n2_p0_dn","","@0-0.2*@0",*n2_p0_2nd);
	...
	RooDoubleCB_spec dcrReso("dcrReso"+chan,"Double Crystal ball ",*mreco,*mzz,*mean_p0_2nd,*sigma_p0_2nd,*a1_p0_2nd,*n1_p0_2nd,*a2_p0_2nd,*n2_p0_2nd);
//	RooDoubleCB_spec dcrReso_up("dcrReso"+chan+"_up","dcb up",*mreco,*mzz,*mean_p0_2nd,*sigma_p0_up,*a1_p0_2nd,*n1_p0_2nd,*a2_p0_2nd,*n2_p0_2nd);
//	RooDoubleCB_spec dcrReso_dn("dcrReso"+chan+"_dn","dcb up",*mreco,*mzz,*mean_p0_2nd,*sigma_p0_dn,*a1_p0_2nd,*n1_p0_2nd,*a2_p0_2nd,*n2_p0_2nd);
...
//		}
	...
	if(onshell){
		Width_conv *convpdf_spline=new Width_conv("ggH"+strSystTitle[f], "ggH"+strSystTitle[f],*mreco, *mean, *sigma, *r, RooArgList(pdf_x, pdf_ggzz,dcrReso),*phase_cos_fix, *phase_sin_fix, *effxkf_sig,*effxkf_bkg); 
...
//	frame_width->Draw();
	...
	TString filename = "workspace125_simple/hzz4l_"+chan+Form("%dS_13TeV.input_func.root",cate_vbf);
	if(onshell)
		filename = "workspace125_onshell_simple/hzz4l_"+chan+Form("%dS_13TeV.input_func.root",cate_vbf);
...
void simpleVersion(TString chan="4e",bool cat_vbf=0, bool onshell=0){
